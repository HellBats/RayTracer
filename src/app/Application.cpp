      ...
      renderer(pixels, viewWidth, viewHeight) 
{
    ...
    InitializeLight(&light1,vec3{0,0,-35},{1,0,0},200,3);
    InitializeLight(&light2,vec3{0,30,-60},{0,1,0},1000,3);
    ...
    triangle1.material.albedo = albedo;
    triangle2.material.albedo = albedo;
